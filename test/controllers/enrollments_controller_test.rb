...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { course_course_id: @enrollment.course_course_id, student_student_id: @enrollment.student_student_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { course_course_id: @enrollment.course_course_id, student_student_id: @enrollment.student_student_id } }
